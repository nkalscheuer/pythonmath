...
#ssh_exec_pass('mutases makunouchi syen', ['ssh', 'nakalscheuer@jeff.cis.cabrillo.edu' 'echo hi'])
def ssh_exec_pass(password, args, capture_output=False):
 ...
 #   retval, _ = ssh_exec_pass(sys.argv[1], sys.argv[2:], False)
  #  exit(retval)
ssh_exec_pass('mutases makunouchi syen', ['ssh', 'nakalscheuer@jeff.cis.cabrillo.edu'])
